...
import FormspreeContactForm from "@/app/components/FormspreeContactForm";
import { FaMapMarkerAlt, FaPhone, FaEnvelope, FaClock } from "react-icons/fa";

export const metadata: Metadata = {
    title: "Contact Us – Evolution Medical Technologies",
    description:
        "Have questions about our medical equipment? Get in touch—our team will respond within one business day.",
};
            ...
            <div className="bg-gradient-to-r from-primary-600 to-secondary-600 text-white py-16">
                <div className="section-container">
                    ...
                    <p className="text-xl text-blue-100 max-w-2xl">
                        Have questions about our medical equipment? We are here to help. Reach out to us and we will
