...
export const metadata = {
    title: "Medical Blogs – Evolution Medical Technologies",
    description: "Insights and updates on medical technology and equipment.",
};
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="section-container py-12">
                <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl shadow-xl p-12 text-center">
                    <div className="max-w-2xl mx-auto">
                        ...
                        <h2 className="text-3xl font-bold text-gray-800 mb-4">Blog Section Coming Soon</h2>
                        <p className="text-xl text-gray-600 mb-8">
                            We are working on bringing you valuable insights, industry updates, and expert perspectives on medical technology.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Link
                                href="/app/(site)/products"
                                className="inline-block bg-gradient-to-r from-primary-600 to-secondary-600 text-white font-semibold py-3 px-8 rounded-lg transition"
                            >
                                Explore Our Products
                            </Link>
                            <Link
                                href="/app/(site)/contact-us"
                                className="inline-block bg-white border-2 border-primary-600 text-primary-600 hover:bg-primary-50 font-semibold py-3 px-8 rounded-lg transition"
                            >
                                Contact Us
                            </Link>
                        </div>
            ...
            <div className="section-container pb-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {blogs.map((b) => (
                        <div key={b.id} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl hover:-translate-y-2 transition">
                            <div className="h-48 overflow-hidden bg-gray-200">
                                <Image src={b.image} alt={b.title} width={800} height={400} className="w-full h-full object-cover" />
                            </div>
                            <div className="p-6">
                <span className="inline-block bg-primary-100 text-primary-700 text-xs font-semibold px-3 py-1 rounded-full mb-3">
                  {b.category}
                </span>
                                <h3 className="text-xl font-bold text-gray-800 mb-3 line-clamp-2">{b.title}</h3>
                                <p className="text-gray-600 mb-4 line-clamp-3">{b.excerpt}</p>
                                ...
                                <div className="mt-4 text-center">
                                    <span className="inline-block bg-gray-100 text-gray-500 text-sm font-medium px-4 py-2 rounded-lg">Coming Soon</span>
                                </div>
                            </div>
                        </div>
                    ))}
