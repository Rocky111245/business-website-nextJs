...
export default function MedicalBlogs() {
    ...
    return (
        <div className="min-h-screen bg-slate-50">
            {/* ===== Deep Navy/Royal Blue Hero Header with dotted grid and wave ===== */}
            <section className="relative isolate text-white">
                ...
                <div className="relative bg-gradient-to-br from-[#0b1b3b] via-[#0e2e6e] to-[#0a58ca]">
                    ...
                    <div
                        ...
                        // radial dots via arbitrary properties
                        style={{
                            background:
                  ...
                  &amp; Insights
                            ...
                            <p className="mx-auto mt-3 max-w-3xl text-base leading-7 text-white/80 sm:text-lg">
                                Stay informed about the latest verified medical innovations and breakthrough
                                technologies shaping modern healthcare.
                            </p>
                        </header>

                        {/* Search — styled for dark hero */}
                        ...
                        {/* Categories — chips tuned for dark background */}
                ...
                {/* wave separator to light section */}
                <svg
                    aria-hidden="true"
                    className="absolute inset-x-0 -bottom-px h-10 w-full text-[#0a58ca]"
                    viewBox="0 0 1440 60"
                    preserveAspectRatio="none"
                >
                    <path
                        fill="currentColor"
                        d="M0,36 C160,54 320,12 480,22 C640,32 800,52 960,36 C1120,20 1280,26 1440,8 L1440,60 L0,60 Z"
                    />
                </svg>
            </section>
            ...
            <div className="mx-auto max-w-7xl px-4 pb-16 pt-8 sm:px-6 lg:px-8">
                <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                    {filteredPosts.map((post) => (
                        <Link
                            key={post.id}
                            href={`/medical-blogs/${post.id}`}
                            className="group overflow-hidden rounded-xl bg-white shadow-md transition-all duration-300 hover:shadow-2xl"
                        >
                  ...
                  <span className="rounded-full bg-blue-600 px-3 py-1 text-xs font-semibold text-white">
                    {post.category}
                            ...
                            <div className="p-6">
                                ...
                                <h2 className="mb-3 line-clamp-2 text-xl font-bold text-slate-900 transition-colors group-hover:text-blue-600">
                                    {post.title}
                                </h2>
